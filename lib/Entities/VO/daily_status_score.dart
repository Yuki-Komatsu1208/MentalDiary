enum DailyStatusParameter { mood, interest, energy, sleepQuality, stressed }
...
dailyStatusParameterDefinitions =
    <DailyStatusParameter, DailyStatusParameterDefinition>{
      DailyStatusParameter.mood: DailyStatusParameterDefinition(
        label: '気分',
        valueLabels: <String>['かなり落ち込む', '少し沈む', 'ふつう', '安定している', 'とても良い'],
        minHint: 'かなり落ち込む',
        maxHint: 'とても良い',
      ),
      DailyStatusParameter.interest: DailyStatusParameterDefinition(
        label: '興味・関心',
        valueLabels: <String>['ほとんど湧かない', '少し湧く', 'ふつう', 'しっかり湧く', '強く湧く'],
        minHint: 'ほとんど湧かない',
        maxHint: '強く湧く',
      ),
      DailyStatusParameter.energy: DailyStatusParameterDefinition(
        label: '活力',
        valueLabels: <String>['ほとんど動けない', 'かなり低い', 'ふつう', '十分にある', 'とても満ちている'],
        minHint: 'ほとんど動けない',
        maxHint: 'とても満ちている',
      ),
      DailyStatusParameter.sleepQuality: DailyStatusParameterDefinition(
        label: '睡眠の質',
        valueLabels: <String>['全く眠れない', 'あまり眠れない', 'ふつう', '概ね眠れている', '安眠できている'],
        minHint: '全く眠れない',
        maxHint: '安眠できている',
      ),
